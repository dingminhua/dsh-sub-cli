  ...
  factory: function (require) {
    ...
    function SetupRow(props) {
      ...
      var testCli = function (id) {
        ...
        }).catch(function () {}).finally(function () { busyState[1](false); });
      };
      return React.createElement("section", { className: "dsc-card" },
        ...
        CLIS.map(function (cli) {
          ...
          var badge = status ? React.createElement("span", { className: "dsc-cli-badge" + (status.installed ? " dsc-cli-badge-ok" : " dsc-cli-badge-bad") }, status.installed ? t("row.installed") : t("row.notInstalled")) : null;
          var ver = status && status.version ? React.createElement("span", { className: "dsc-cli-ver" }, t("row.version") + ": " + status.version) : null;
          var testBtn = React.createElement(Button, { type: "button", variant: "outline", size: "sm", onClick: function () { testCli(cli.id); } }, t("row.test"));
          return React.createElement("div", { className: "dsc-cli", key: cli.id },
            React.createElement("div", { className: "dsc-cli-head" },
              cli.name,
              badge,
              ver,
              testBtn

...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var EN = {
      ...
      "row.connectionTest": "Connection test",
      "row.install": "Install",
      "row.update": "Install / update",
    ...
    function SetupRow(props) {
      ...
      return React.createElement("section", { className: "dsc-card" },
        ...
        CLIS.map(function (cli) {
          ...
          var installLabel = status && status.installed ? t("row.update") : t("row.install");
          var installBtn = React.createElement(Button, { type: "button", variant: "outline", size: "xs", disabled: true, title: status && status.install ? status.install : "" }, installLabel);
          var versionBtn = React.createElement(Button, { type: "button", variant: "outline", size: "xs", disabled: !!cliBusy, onClick: function () { checkVersion(cli.id); } }, cliBusy === "version" ? t("row.checkingVersion") : t("row.versionCheck"));
          var connectionBtn = React.createElement(Button, { type: "button", variant: "outline", size: "xs", disabled: true }, t("row.connectionTest"));
          return React.createElement("div", { className: "dsc-cli", key: cli.id },
            React.createElement("div", { className: "dsc-cli-title-row" },
              ...
              React.createElement("div", { className: "dsc-cli-actions" }, installBtn, versionBtn, connectionBtn)
            ),
